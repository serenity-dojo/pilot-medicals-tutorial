...
Feature: Date of next medical 2.10
  ...
  Rule: The date of the next examination depends on the class of license and the age of the pilot
    ...
    Scenario Outline: Transport Examination date rules
      ...
      Examples: Transport First class pilots
      ...
      Examples: Transport Second class pilots
      ...
      Examples: Transport Third class pilots
