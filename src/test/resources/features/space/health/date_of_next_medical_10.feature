@Sea
Feature: Space Date of next medical 10
  ...
  Rule: The date of the next examination depends on the class of license and the age of the pilot
    ...
    Scenario Outline: Sea Travel Examination date rules
      ...
      Examples: Sea Travel First class pilots
      ...
      Examples: Sea Travel Second class pilots
      ...
      Examples: Sea Travel Third class pilots
