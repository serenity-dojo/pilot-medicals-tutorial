...
Feature: Certificate expiry 3.1
  ...
  Rule: If the medical date is not respected the pilot license may expire or be downgraded
    ...
    Scenario Outline: Drone When medical certificates expire
      ...
      Examples: Drone Expiry rules for first class pilots
      ...
      Examples: Drone Expiry rules for second class pilots
        | Class     | Birth Date      | Last Medical    | Current Date    | New Class | Next Medical    | Comments           |
    ...
    Scenario Outline: Drone When a 3rd class pilot misses their medical their license expires
