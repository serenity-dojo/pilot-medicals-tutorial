@Space
Feature: Date of next medical 4.10
  ...
  Rule: The date of the next examination depends on the class of license and the age of the pilot
    ...
    Scenario Outline: Space Travel Examination date rules
      ...
      Examples: Space Travel First class pilots
      ...
      Examples: Space Travel Second class pilots
      ...
      Examples: Space Travel Third class pilots
