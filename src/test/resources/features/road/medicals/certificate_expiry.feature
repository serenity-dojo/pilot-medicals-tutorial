@Road
Feature: Road Medicals Certificate expiry
  ...
  Rule: If the medical date is not respected the pilot license may expire or be downgraded
    ...
    Scenario Outline: Road Travel When medical certificates expire
      ...
      Examples: Road Travel Expiry rules for first class pilots
      ...
      Examples: Road Travel Expiry rules for second class pilots
        | Class     | Birth Date      | Last Medical    | Current Date    | New Class | Next Medical    | Comments           |
    ...
    Scenario Outline: Road Travel When a 3rd class pilot misses their medical their license expires
      Given Theo is a 3rd class pilot born on <Birth Date>
      When his last medical was on the <Last Medical>
      And today is the <Current Date>
      Then his license should now be <New Class>
      Examples: Road Travel
