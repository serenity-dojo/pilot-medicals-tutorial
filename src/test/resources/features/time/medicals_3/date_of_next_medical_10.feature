...
Feature: Date of next medical 3.10
  ...
  Rule: The date of the next examination depends on the class of license and the age of the pilot
    ...
    Scenario Outline: Time Travel Examination date rules
      ...
      Examples: Time Travel First class pilots
      ...
      Examples: Time Travel Second class pilots
      ...
      Examples: Time Travel Third class pilots
