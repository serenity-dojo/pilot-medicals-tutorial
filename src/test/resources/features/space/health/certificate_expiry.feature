@Sea
Feature: Space Certificate expiry
  ...
  Rule: If the medical date is not respected the pilot license may expire or be downgraded
    ...
    Scenario Outline: Sea Travel When medical certificates expire
      ...
      Examples: Sea Travel Expiry rules for first class pilots
      ...
      Examples: Sea Travel Expiry rules for second class pilots
        | Class     | Birth Date      | Last Medical    | Current Date    | New Class | Next Medical    | Comments           |
    ...
    Scenario Outline: Sea Travel When a 3rd class pilot misses their medical their license expires
